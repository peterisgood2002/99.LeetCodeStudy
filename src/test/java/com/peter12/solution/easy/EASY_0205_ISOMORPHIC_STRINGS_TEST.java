 ...
 */
public class EASY_0205_ISOMORPHIC_STRINGS_TEST 
    extends TestCase
{
    /**
     ...
     */
    public EASY_0205_ISOMORPHIC_STRINGS_TEST( String testName )
    {
        super( testName );
    }
    ...
    {
        return new TestSuite( EASY_0205_ISOMORPHIC_STRINGS_TEST.class );
    }
